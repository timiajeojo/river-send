...
export default function ActivityPage() {
  ...
  const navItems = [
    ...
    { id: "transfer", label: "Transfer", route: "/dashboard", icon: <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg> },
    ...
    <div className="min-h-svh w-full bg-[#f5f5f5] flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 overflow-y-auto pb-24 lg:pb-10">
          <div className="px-5 pt-6 lg:px-8 lg:pt-8 w-full max-w-[600px] lg:max-w-none mx-auto">
            ...
            {/* Search + filters row — desktop: side by side */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
              ...
              <button type="button" className="hidden lg:flex items-center gap-2 px-4 py-3 bg-white border border-gray-200 rounded-2xl text-[13px] font-semibold text-gray-600 cursor-pointer hover:bg-gray-50 transition-colors shrink-0">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/>
                </svg>
                Export
            ...
            {groupKeys.length === 0 ? (
              ...
              /* On desktop: 2-column grid of groups */
                  ...
                  <div key={group}>
                    ...
                    <div className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm">
                      {grouped[group].map((tx, i) => (
                        <div
                          key={tx.id}
                          className={`flex items-center gap-3 sm:gap-4 px-4 py-3.5 sm:py-4 cursor-pointer hover:bg-gray-50 transition-colors ${
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                              <p className="text-[11px] sm:text-[12px] text-gray-400 whitespace-nowrap">{tx.date} · {tx.time}</p>
