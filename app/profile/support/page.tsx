...
function FaqItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className={`border-b border-gray-50 last:border-0`}>
      <button type="button" onClick={() => setOpen(v => !v)} className="w-full flex items-center justify-between px-5 py-4 text-left border-none cursor-pointer bg-transparent hover:bg-gray-50 transition-colors">
