...
export default function TransferPage() {
  ...
  const handleContinue = async () => {
    ...
    setLoading(false);
    setSuccess(true);
    setTimeout(() => { setSuccess(false); setAmount(""); setNote(""); }, 2500);
  };
    ...
    <div className="min-h-svh w-full bg-[#f5f5f5] flex flex-col lg:flex-row">
      ...
      <aside className="hidden lg:flex flex-col w-[240px] xl:w-[260px] shrink-0 bg-white border-r border-gray-100 min-h-screen sticky top-0">
        ...
        <nav className="flex-1 px-4 py-6 flex flex-col gap-1">
          {navItems.map((item) => (
            ...
            >
              <span className={item.id === "transfer" ? "text-gray-900" : "text-gray-400"}>{item.icon}</span>
              {item.label}
              {item.id === "transfer" && <span className="ml-auto w-1.5 h-1.5 rounded-full bg-[#AAFF00]" />}
            </button>
          ))}
        </nav>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 overflow-y-auto pb-24 lg:pb-10">
          <div className="px-4 pt-5 sm:px-6 sm:pt-6 lg:px-8 lg:pt-8 w-full max-w-[640px] md:max-w-none mx-auto">
            ...
            <div className="flex items-center justify-between mb-6 lg:hidden">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[15px] sm:text-[16px] font-bold text-gray-900 leading-tight">Transfer</p>
            ...
            <h1 className="text-[26px] sm:text-[30px] font-extrabold text-gray-900 tracking-tight mb-6 lg:hidden">
              Send Money
            </h1>

            {/* Two-col grid: md+ */}
            <div className="flex flex-col md:grid md:grid-cols-2 md:gap-8 lg:gap-10">
              ...
              <div className="flex flex-col gap-5">
                ...
                {/* Send To */}
                <div>
                  <p className="text-[13px] font-semibold text-gray-500 mb-2">Send to</p>
                  <div className="relative">
                    <button
                      type="button"
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="text-left">
                        ...
                        <p className="text-[12px] text-gray-400 mt-0.5">Available: {selectedAccount.balance}</p>
                      </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm px-5 py-5">
                    <div className="flex items-center justify-end">
                      <input
                        ...
                        className="w-full min-w-0 text-right text-[38px] sm:text-[44px] lg:text-[40px] xl:text-[48px] font-extrabold text-gray-900 tracking-tight bg-transparent outline-none border-none placeholder-gray-300 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                      />
                    </div>
