...
exports.onAuthChange = exports.logOut = exports.signInWithGoogle = exports.signIn = exports.signUp = void 0;
...
function signIn(email, password) {
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, auth_1.signInWithEmailAndPassword)(firebase_1.auth, email, password)];
                case 1:
                    credential = _a.sent();
                    return [2 /*return*/, credential.user];
            }
