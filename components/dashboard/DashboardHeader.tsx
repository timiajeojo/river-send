  ...
  return (
    <div className="flex items-center justify-between mb-5">
      <div className="flex items-center gap-3">
        <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full overflow-hidden ring-2 ring-[#AAFF00]/40 shrink-0">
          <img
        ...
        <div>
          <p className="text-[15px] sm:text-[16px] font-bold text-gray-900 leading-tight">
            Hello Tega 👋
          </p>
          <p className="text-[12px] sm:text-[13px] text-gray-400">Welcome back</p>
        </div>
      </div>
